...
const TRANSLATIONS = {
  en: {
    ...
    export_unrestricted_desc: "After importing, your counterpart immediately sees the question catalogue (incl. scales and personalisations) and your saved answers.",
    export_restricted_title: "Restricted export",
    export_restricted_desc: "Exports the question catalogue and your answers. The answers are additionally password-protected — your counterpart can answer independently first, then reveal yours for comparison.",
    export_template_title: "Export as template",
    export_template_desc: "Your counterpart receives only the question catalogue (incl. scales and personalisations), without your answers. Great for answering in parallel.",
    ...
    template_warning: "You are modifying a card that was created from a template. This may cause the question catalogue to no longer be identical to your counterpart's, which can lead to problems with overlapping display or incomplete comparisons.",
    ...
    pick_template_source_sub: "Choose a card whose structure (categories, questions, scale) to use as template. No answers will be copied.",
  ...
  de: {
    ...
    export_unrestricted_desc: "Dein Gegenüber sieht nach dem Import neben dem Fragenkatalog (inkl. Skalen und Personalisierungen) auch sofort deine bisher gespeicherten Antworten.",
    export_restricted_title: "Eingeschränkt exportieren",
    export_restricted_desc: "Exportiert den Fragenkatalog und deine Antworten. Die Antworten sind jedoch zusätzlich passwortgeschützt — dein Gegenüber kann zuerst unabhängig antworten und danach die Antworten einsehen.",
    export_template_title: "Als Vorlage exportieren",
    export_template_desc: "Dein Gegenüber erhält nur den Fragenkatalog (inkl. Skalen und Personalisierungen), ohne deine Antworten. Ideal, um parallel zu antworten.",
    ...
    template_warning: "Du änderst eine auf einer Vorlage basierende Karte. Dies kann dazu führen, dass der Fragenkatalog nicht mehr identisch mit deinem Gegenüber ist und zu Problemen bei der überlappenden Darstellung oder inkompletten Vergleichen führen.",
    ...
    pick_template_source_sub: "Wähle eine Karte, deren Struktur (Kategorien, Fragen, Skala) als Vorlage dienen soll. Antworten werden nicht übernommen.",
