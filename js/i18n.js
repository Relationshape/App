...
const TRANSLATIONS = {
  en: {
    ...
    howto_step4_desc: "View radar charts and alignment overviews — then optionally export your answers as an AES-encrypted file to share with your counterpart. No server involved.",
  ...
  de: {
    ...
    howto_step4_desc: "Sieh dir Netzdiagramme und Übereinstimmungsübersichten an – und exportiere deine Antworten optional als AES-verschlüsselte Datei. Kein Server, kein Umweg.",
