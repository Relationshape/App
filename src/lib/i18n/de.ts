...
export const DE: Record<TranslationKey, string> = {
  ...
  btn_unlock_answers: '🔓 Antworten entsperren',
  unlock_answers_title: 'Antworten entsperren',
  unlock_answers_intro: 'Gib das Passwort zum Anzeigen der Antworten ein.',
  unlock_answers_pass_label: 'Antwort-Passwort',
