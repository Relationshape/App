...
export const DE: Record<TranslationKey, string> = {
  ...
  lbl_giving: 'Geben / aktive Rolle',
  lbl_receiving: 'Empfangen / passive Rolle',
  ...
  btn_use_as_template: 'Neue Karte aus Vorlage',
  btn_copy_map: 'Karte kopieren',
  copy_map_title: 'Karte kopieren',
  copy_map_with_answers: 'Mit Antworten',
  copy_map_without_answers: 'Ohne Antworten (leer)',
  ...
  q_nav_see_results: 'Ergebnisse',
  q_nav_next_cat: 'Nächste Kategorie →',
  q_nav_prev_cat: '← Vorherige Kategorie',
  ...
  import_adopt_cats_title: 'Eigene Inhalte in diesem Import',
  import_adopt_cats_body: 'Dieser Import enthält eigene Kategorien und/oder Elemente. Füge sie einem Profil hinzu, damit sie in neuen Karten automatisch erscheinen.',
  import_adopt_cats_select_profile: 'Zu Profil hinzufügen',
  import_adopt_cats_btn: 'Zum Profil hinzufügen',
  import_adopt_items_header: 'Eigene Elemente für Standardkategorien',
  ...
  q_format_text_badge: 'Freitextantwort',
  ...
  q_format_double_scale: 'Doppelskala',
  q_format_double_scale_desc: 'unterscheidet Geben/Empfangen',
  q_format_double_scale_badge: 'Doppelskala (Geben/Empfangen)',
