...
export const EN = {
  ...
  btn_unlock_answers: '🔓 Unlock answers',
  unlock_answers_title: 'Unlock answers',
  unlock_answers_intro: 'Enter the password to unlock the answers.',
  unlock_answers_pass_label: 'Answer password',
